...
from bert_model import MFMCGCNABSA
...
class ABSATrainer(object):
    def __init__(self, args, emb_matrix=None):
        ...
        optimizer_grouped_parameters = [
            {"params": base_params},
            {"params": filter(lambda p: p.requires_grad, bert_model.parameters()), "lr": args.bert_lr},
        ]
